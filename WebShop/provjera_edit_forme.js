  ...
  if(pass.match(/(\D|\d){6}/)){document.getElementById("pwd").style.color="red";document.getElementById("pwd").innerHTML="Weak";check_pass=1 ;document.getElementById("pwd").style.marginBottom="0px";}
	  ...
	  if (pass.length<7) { document.getElementById("pwd").innerHTML="";document.getElementById("pwd").style.marginBottom="20px";check_pass=0;}
  ...
  if(!check_all){ window.location.href = 'http://localhost/php_test/website/editiranje_profila.php';; document.getElementById("pwd").innerHTML=""; document.getElementById("telefon").innerHTML="";document.getElementById("adress").innerHTML="";document.getElementById("IME").innerHTML=""; document.getElementById("PREZIME").innerHTML="";document.getElementById("MJESTO").innerHTML="";document.getElementById("USER").innerHTML="";document.getElementById("MAIL").innerHTML="";
  }
